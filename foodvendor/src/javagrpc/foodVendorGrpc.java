...
public final class foodVendorGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<javagrpc.Foodvendor.VendorIngredientData,
      javagrpc.Foodvendor.IngredientMap> getGetIngredientFromVendorMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "getIngredientFromVendor",
      requestType = javagrpc.Foodvendor.VendorIngredientData.class,
      responseType = javagrpc.Foodvendor.IngredientMap.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<javagrpc.Foodvendor.VendorIngredientData,
      javagrpc.Foodvendor.IngredientMap> getGetIngredientFromVendorMethod() {
    io.grpc.MethodDescriptor<javagrpc.Foodvendor.VendorIngredientData, javagrpc.Foodvendor.IngredientMap> getGetIngredientFromVendorMethod;
      ...
      synchronized (foodVendorGrpc.class) {
        if ((getGetIngredientFromVendorMethod = foodVendorGrpc.getGetIngredientFromVendorMethod) == null) {
          foodVendorGrpc.getGetIngredientFromVendorMethod = getGetIngredientFromVendorMethod = 
              io.grpc.MethodDescriptor.<javagrpc.Foodvendor.VendorIngredientData, javagrpc.Foodvendor.IngredientMap>newBuilder()
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  javagrpc.Foodvendor.IngredientMap.getDefaultInstance()))
  ...
  public static abstract class foodVendorImplBase implements io.grpc.BindableService {
    ...
    public void getIngredientFromVendor(javagrpc.Foodvendor.VendorIngredientData request,
        io.grpc.stub.StreamObserver<javagrpc.Foodvendor.IngredientMap> responseObserver) {
          ...
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                ...
                javagrpc.Foodvendor.IngredientMap>(
  ...
  public static final class foodVendorBlockingStub extends io.grpc.stub.AbstractStub<foodVendorBlockingStub> {
    ...
    /**
     */
    public javagrpc.Foodvendor.IngredientMap getIngredientFromVendor(javagrpc.Foodvendor.VendorIngredientData request) {
  ...
  public static final class foodVendorFutureStub extends io.grpc.stub.AbstractStub<foodVendorFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<javagrpc.Foodvendor.IngredientMap> getIngredientFromVendor(
