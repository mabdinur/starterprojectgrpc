...
public final class foodSupplierGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<javagrpc.Ingredients.Ingredient,
      javagrpc.VendorsOuterClass.Vendors> getGetVendorsByIngredientMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "getVendorsByIngredient",
      requestType = javagrpc.Ingredients.Ingredient.class,
      responseType = javagrpc.VendorsOuterClass.Vendors.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<javagrpc.Ingredients.Ingredient,
      javagrpc.VendorsOuterClass.Vendors> getGetVendorsByIngredientMethod() {
    io.grpc.MethodDescriptor<javagrpc.Ingredients.Ingredient, javagrpc.VendorsOuterClass.Vendors> getGetVendorsByIngredientMethod;
      ...
      synchronized (foodSupplierGrpc.class) {
        if ((getGetVendorsByIngredientMethod = foodSupplierGrpc.getGetVendorsByIngredientMethod) == null) {
          foodSupplierGrpc.getGetVendorsByIngredientMethod = getGetVendorsByIngredientMethod = 
              io.grpc.MethodDescriptor.<javagrpc.Ingredients.Ingredient, javagrpc.VendorsOuterClass.Vendors>newBuilder()
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  javagrpc.VendorsOuterClass.Vendors.getDefaultInstance()))
  ...
  public static abstract class foodSupplierImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getVendorsByIngredient(javagrpc.Ingredients.Ingredient request,
        io.grpc.stub.StreamObserver<javagrpc.VendorsOuterClass.Vendors> responseObserver) {
          ...
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                ...
                javagrpc.VendorsOuterClass.Vendors>(
  ...
  public static final class foodSupplierBlockingStub extends io.grpc.stub.AbstractStub<foodSupplierBlockingStub> {
    ...
    /**
     */
    public javagrpc.VendorsOuterClass.Vendors getVendorsByIngredient(javagrpc.Ingredients.Ingredient request) {
  ...
  public static final class foodSupplierFutureStub extends io.grpc.stub.AbstractStub<foodSupplierFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<javagrpc.VendorsOuterClass.Vendors> getVendorsByIngredient(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_VENDORS_BY_INGREDIENT:
          serviceImpl.getVendorsByIngredient((javagrpc.Ingredients.Ingredient) request,
              (io.grpc.stub.StreamObserver<javagrpc.VendorsOuterClass.Vendors>) responseObserver);
          break;
        default:
